 ...
 * @author Cliverson
 */
public class FunctionsScreen extends javax.swing.JFrame
{
    Session ss;
    /**
     ...
     * @param ss
     */
    public FunctionsScreen(Session ss)
    {
        initComponents();
        this.ss = ss;
    }
    ...
    private void initComponents()
    {
        ...
        middleRightLabel.setText("DEPOSIT");
        ...
        upperRightLabel.setText("WITHDRAW");
    ...
    {//GEN-HEADEREND:event_bottomRightButtonActionPerformed
        StartScreen sts = new StartScreen();
        sts.setVisible(true);
    ...
    {//GEN-HEADEREND:event_upperRightButtonActionPerformed
        ss.function = "Withdraw";
        WithdrawValuesScreen wvs = new WithdrawValuesScreen(ss);
        wvs.setVisible(true);
        this.setVisible(false);
